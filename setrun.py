...
#------------------------------
    ...
    probdata.add_param('rho',     1.22,  'density of medium')
    probdata.add_param('bulk',    142000.,  'bulk modulus')
    probdata.add_param('rho2',    1000.,  'density of medium')
    probdata.add_param('bulk2',   2200000000.,  'bulk modulus')
    probdata.add_param('rho3',    1050.,  'density of medium')
    probdata.add_param('bulk3',   5554500000.,  'bulk modulus')
    ...
    clawdata.lower[0] = -0.010000e+00          # xlower
    clawdata.upper[0] = 0.010000e+00          # xupper
    clawdata.lower[1] = -0.010000e+00          # ylower
    clawdata.upper[1] = 0.010000e+00          # yupper
